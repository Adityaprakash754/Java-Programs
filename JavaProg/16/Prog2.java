//Using java collections implement comparator and comparable interface to sort an arrayList of type Employee 
import java.util.*;
import java.io.*;
...
//compareTo only compares Strings/ Objects
       // return (e1.Esal).compareTo(e2.Esal);
       // incorrect - return Integer.compareTo(this.Esal,e1.Esal);